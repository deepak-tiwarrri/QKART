...
const getCartByUser = async (user) => {
  const cartResult = await Cart.findOne({ email: user.email });
  if (cartResult === null) {
...
//         "User cart creation failed, user already have cart"
//       );
//     }
//   }
...
//   //add product to cart, if not there create one and add it , else show error
//   let productIndx = -1;
...
//   } else {
//     cart.cartItems[productIndx].quantity = quantity;
//   }
//   await cart.save();
//   return cart;
// };
